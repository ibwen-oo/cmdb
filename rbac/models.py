...
class Permission(models.Model):
    ...
    action = models.CharField(verbose_name="请求要做什么操作,对应请求方法", max_length=16, null=True)
    ...
    pid = models.ForeignKey(verbose_name='关联的权限', to='Permission', null=True,
                            blank=True, related_name='parents',
                            help_text='对于非菜单权限需要选择一个可以成为菜单的权限,用做默认展开和选中菜单',
